    ...
    switch (theme) {
      case 'light':
        return {
          ...
          navbarScrolled: 'bg-white/90 backdrop-blur-md shadow-lg border-b border-gray-200/20',
        };
      case 'purple':
        return {
          ...
          navbarScrolled: 'bg-purple-900/90 backdrop-blur-md shadow-lg border-b border-purple-500/20',
        };
      default: // dark
        return {
          ...
          navbarScrolled: 'bg-white/10 backdrop-blur-md shadow-lg border-b border-white/20',
        };
    }
  };
