        ...
        >
          ...
          <ScrollAnimation>
            <div className="text-center mb-8">
              ...
              <div
                className={`${themeClasses.glass} rounded-2xl border p-4 mb-6 shadow-lg`}
              >
                <h2
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                <AnimatePresence>
                  {sortedSchedule.length === 0 ? (
                    ...
                    >
                      <ClockIcon
                        className={`w-16 h-16 ${themeClasses.textSecondary} opacity-50 mx-auto mb-4`}
                      />
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 mt-2 text-sm text-gray-400">
                                <div
                                  className={`flex items-center gap-4 mt-2 text-sm ${themeClasses.textSecondary}`}
                                >
