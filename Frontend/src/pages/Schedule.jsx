...
function Schedule() {
  ...
  const fetchSchedule = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/api/schedule/fetch`,
        {
          headers: {
  ...
  const scheduleCreate = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/schedule/schedule`,
        {
          text: newTask,
  ...
  const toggleCompleteStatus = async (taskId) => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_BACKEND_URL}/api/schedule/update/${taskId}`,
  ...
  const scheduleDelete = async (id) => {
    try {
      await axios.delete(
        `${import.meta.env.VITE_BACKEND_URL}/api/schedule/delete/${id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("jwt")}`,
          },
